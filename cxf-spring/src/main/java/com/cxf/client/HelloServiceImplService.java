 ...
 * 2017-07-03T21:52:23.501+08:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", 
                  wsdlLocation = "http://localhost:8080/cxf-spring/servlet/HelloService?wsdl",
                  targetNamespace = "com.cxf.service") 
public class HelloServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("com.cxf.service", "HelloServiceImplService");
    public final static QName HelloServiceImplPort = new QName("com.cxf.service", "HelloServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/cxf-spring/servlet/HelloService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/cxf-spring/servlet/HelloService?wsdl");
        }
        WSDL_LOCATION = url;
    }
