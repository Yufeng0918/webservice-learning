 ...
 * generated in the com.dbs.services.person package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPerson_QNAME = new QName("http://services.dbs.com/", "getPerson");
    private final static QName _GetPersonResponse_QNAME = new QName("http://services.dbs.com/", "getPersonResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.dbs.services.person
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.dbs.com/", name = "getPerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.dbs.com/", name = "getPersonResponse")
